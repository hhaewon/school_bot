...
from api.responses import MealServiceResponse, TimeTableResponse, MiddleTimeTableRow, SchoolScheduleResponse
...
async def main():
    ...
    school_info_response: SchoolScheduleResponse
    meal_service_response, time_table_response, school_schedule_response = await asyncio.gather(SchoolApi.request_meal_service(params=params),
                             SchoolApi.request_middle_time_table(params=params),
