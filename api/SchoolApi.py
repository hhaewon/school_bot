...
from api.responses.SchoolScheduleResponse import SchoolScheduleResponse, SchoolScheduleRow
...
class SchoolApi:
    ...
    @classmethod
    async def request_elementary_time_table(cls, params: RequestParameters) -> TimeTableResponse[ElementaryTimeTableRow]:
    ...
    @classmethod
    async def request_middle_time_table(cls, params: RequestParameters) -> TimeTableResponse[MiddleTimeTableRow]:
    ...
    @classmethod
    async def request_high_time_table(cls, params: RequestParameters) -> TimeTableResponse[HighTimeTableRow]:
